    ...
    <ul class="cinema-list">
      <li class="cinema-item">
        ...
        <ul class="cinema-tags">
          <li class="tag-item endore" v-if="cinema.endorse">改签</li>
          <li class="tag-item vipTag" v-if="cinema.vipDesc">折扣卡</li>
          <li class="tag-item allowRefund" v-if="cinema.allowRefund">退</li>
          <li class="tag-item snack" v-if="cinema.snack">退</li>
          <ul class="hall-type">
            <li class="tag-item hall-type-item" v-for="type in cinema.hallType" :Key="type">{{type}}</li>
          </ul>
        </ul>
